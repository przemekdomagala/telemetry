...
const API_URL = `${import.meta.env.VITE_API_URL}/battery`;

function BatteriesHistoric({ selectedStart, selectedEnd }) {
    ...
    useEffect(() => {
        ...
        ctx.lineWidth = 0.5;
        const yAxisStep = 1;
        for (let i = Math.ceil(yAxisMin); i <= Math.floor(yAxisMax); i += yAxisStep) {
        ...
        drawLine('left_battery_voltage', '#ff0000', 'Left');
...
export default BatteriesHistoric;